    ...
    <div>
      <div className="fixed top-[25px] right-[30px] z-40 rounded-3xl">
        <motion.div
          ...
          initial="closed"
          className="w-[240px] h-[425px] bg-background rounded-3xl relative"
        >
          <MobileNav isActive={isActive} setIsActive={setIsActive} />
        </motion.div>
        <button
          onClick={() => setIsActive(!isActive)}
          className="absolute top-0 right-0 w-[32px] h-[32px] flex justify-center items-center cursor-pointer rounded-3xl bg-background-highlights border-[2px] border-text overflow-hidden"
        >
          <motion.div
