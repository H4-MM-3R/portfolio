...
export default function Terminal() {
    ...
    return (
        <div
            className={cn(
                fontNerd.className,
                "bg-background text-text p-[1.5em] h-full overflow-y-auto text-sm transition-all duration-500",
            )}
            ref={terminalRef}
            onClick={handleClick}
        >
            ...
            <div className="flex">
                ...
                <input
                    ref={inputRef}
                    className="outline-none bg-[#FDF6E3] dark:bg-[#002B36] dark:text-[#93A1A1] text-[#586E75] pl-[1em] transition-all duration-500"
                    value={command}
