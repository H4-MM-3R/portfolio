    ...
    const processCommand = (command: string) => {
        switch (command.toLowerCase()) {
            ...
            case "socials":
                return (
                    <div>
                        <div>Github: <Link className = "underline text-[#268BD2]" href="https://github.com/kuheram777">https://github.com/kuheram777</Link></div>
                        <div>Linkedin: <Link className = "underline text-[#268BD2]" href="https://www.linkedin.com/in/hemram-kumarapu-440859214/">https://www.linkedin.com/in/hemram-kumarapu-440859214/</Link></div>
                        <div>Email: <Link className = "underline text-[#268BD2]" href="mailto:kuheram777@gmail.com">kuheram777@gmail.com</Link></div>
                    </div>
                );
            case "projects":
                return <div>Navigating to projects...</div>;
            case "blog":
                return <div>Navigating to blog...</div>;
            case "resume":
            ...
            <div className="mb-[1em]">
                ...
                {output.map((item: any, index: any) => (
                    <div className="mb-[0.2em]" key={index}>
                        <h1 className={clsx(fontNerd.className, "mb-[0.1em] text-sm")}>
